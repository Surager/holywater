...
FRAGMENTS: list[tuple[str, str, str | None, str | None, float]] = [
    ...
    ("subject", "被通知声牧养的人", None, "absurd", 0.9),
    ...
    ("action", "他在众标签页面前喝水", None, "absurd", 1.0),
    ...
    ("simple_action", "暂离屏幕，饮了几口", None, "serious", 1.0),
    ("simple_action", "把杯口带到唇边", "psalm", "serious", 0.9),
    ("simple_action", "郑重其事地拧开瓶盖", None, "absurd", 1.0),
    ("simple_action", "在众标签页面前喝水", None, "absurd", 1.0),
    ...
    ("imperative_action", "暂离屏幕，饮几口水", None, "serious", 1.0),
    ("imperative_action", "郑重其事地拧开瓶盖", None, "absurd", 1.0),
    ("imperative_action", "在众标签页面前喝水", None, "absurd", 1.0),
    ...
    ("absurd_result", "众窗口都暂时闭口不言", None, "absurd", 1.0),
    ...
    ("context_scene", "消息如雨落下的地方", None, "absurd", 0.9),
    ...
    ("body_part", "灵魂的进度条", None, "absurd", 0.9),
    ...
    ("absurd_image", "没有出口的表格迷宫", None, "absurd", 1.0),
    ("absurd_image", "吞吃专注力的滚动条", None, "absurd", 1.0),
    ("absurd_image", "自称先知的低电量图标", None, "absurd", 1.1),
    ...
    ("parallel_result", "众标签页不再审问你的灵魂", None, "absurd", 1.0),
